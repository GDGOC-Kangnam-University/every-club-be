...
public record ClubUpdateRequest(
        ...
        @Schema(description = "상세 소개", example = "이번 학기 모집에 맞춰 소개 문구를 수정한 예시입니다.")
        String description,
        ...
        @Schema(description = "배너 이미지 URL", example = "https://cdn.everyclub.app/clubs/gdgoc/banner-spring.png")
        @Size(max = 2048)
        String bannerUrl,

        @Schema(description = "가입 신청 폼 URL", example = "https://forms.gle/gdgoc-spring")
        @Size(max = 2048)
        String joinFormUrl,
        ...
        @Schema(description = "태그 목록. 최소 1개, 최대 20개까지 입력할 수 있습니다.", example = "[\"개발\", \"안드로이드\", \"커뮤니티\"]")
